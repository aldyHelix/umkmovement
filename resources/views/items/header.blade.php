...
<head>
    ...
    <title>UMKMOVEMENT</title>
    <!--title icon -->
    <link rel="icon" href="{{asset('images2/iconumkmovement.ico')}}" type="image/png">
    <!-- Bootstrap Core CSS -->
    ...
    <!-- Colors CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('css/color/light-red.css')}}">
    <!-- Colors CSS -->
